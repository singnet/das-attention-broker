...
public:
    ...
    TestMessage(string command, vector<string> args) {
        cout << "XXXXX " << "TestMessage::TestMessage() " << command << " " << args.size() << endl;
...
public:
    ...
    Message *message_factory(string &command, vector<string> &args) {
        cout << "XXXXX " << "TestCacheNodeServer::message_factory() " << command << " " << args.size() << endl;
...
public:
    ...
    Message *message_factory(string &command, vector<string> &args) {
        cout << "XXXXX " << "TestCacheNodeClient::message_factory() " << command << " " << args.size() << endl;
        Message *message = CacheNode::message_factory(command, args);
        if (message != NULL) {
            return message;
        }
